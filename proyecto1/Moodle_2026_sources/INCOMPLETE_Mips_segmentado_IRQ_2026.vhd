...
-- Internal signals MIPS	
	...
	signal RW_EX, RW_EX_int, RW_MEM, RW_WB, Reg_Rs_ID, Reg_Rs_EX, Reg_Rt_ID, Reg_Rd_EX, Reg_Rt_EX: std_logic_vector(4 downto 0);
...
-- COMPLETE:
	...
	signal jal_ID, ret_ID, jal_EX, ret_EX, jal_MEM, ret_MEM, jal_WB : std_logic; 
...
begin
	...
	load_pc <= not(stall_MIPS) and not(stall_ID);
	...
	load_ID <= not(stall_MIPS) and not(stall_ID);
	...
	Banco_ID_EX: Banco_EX PORT MAP ( 	clk => clk, reset => reset_EX, load => load_EX, busA => busA, busB => busB, busA_EX => busA_EX, busB_EX => busB_EX,
						...
						ext_word_1_ID => PC4_ID, ext_word_2_ID => x"00000000", ext_signal_1_ID => JAL_ID, ext_signal_2_ID => RET_ID,
						ext_word_1_EX => PC4_EX, ext_word_2_EX => open, ext_signal_1_EX => JAL_EX, ext_signal_2_EX => RET_EX
						);  		
	...
	mux_dst: mux2_5bits port map (Din0 => Reg_Rt_EX, DIn1 => Reg_Rd_EX, ctrl => RegDst_EX, Dout => RW_EX_int);
	...
	Banco_EX_MEM: Banco_MEM PORT MAP ( 	ALU_out_EX => ALU_out_EX, ALU_out_MEM => ALU_out_MEM, clk => clk, reset => reset_MEM, load => load_MEM, MemWrite_EX => MemWrite_EX,
										...
										-- Extension ports. Initially they are disconnected
										ext_word_1_EX => PC4_EX, ext_word_2_EX => x"00000000", ext_signal_1_EX => JAL_EX, ext_signal_2_EX => ret_EX,
	...
	Banco_MEM_WB: Banco_WB PORT MAP ( 	ALU_out_MEM => ALU_out_MEM, ALU_out_WB => ALU_out_WB, Mem_out => Mem_out, MDR => MDR, clk => clk, reset => reset, load => load_WB, 
										...
										-- Extension ports. Initially they are disconnected
										ext_word_1_MEM => PC4_MEM, ext_word_2_MEM => x"00000000", ext_signal_1_MEM => JAL_MEM, ext_signal_2_MEM => ret_MEM,
...
-------------------------------------------------------------------------------------------------- 
	...
	inc_cycles <= '1';--Done
	inc_I <= '1' when (valid_I_WB = '1' and stall_MIPS = '0') else '0'; -- Dynamic instruction count: valid instructions completing in WB. 
	inc_data_stalls <= '1' when (stall_ID = '1' and stall_MIPS = '0') else '0'; -- Stall cycles due to data hazards
	inc_control_stalls <= '1' when (Kill_IF = '1' and stall_MIPS = '0') else '0'; -- Stall cycles due to control hazards
	inc_Exceptions <= Exception_accepted; -- Total number of accepted exceptions
	inc_Mem_stalls <= '1' when (valid_I_MEM = '1' and IO_MEM_ready = '0') else '0'; -- Structural Stall cycles due to multi-cycle memory references
	inc_EX_stalls <= '1' when (valid_I_EX = '1' and ALU_ready = '0' and not(valid_I_MEM = '1' and IO_MEM_ready = '0')) else '0'; -- Structural Stall cycles generated by the multi-cycle MAC operations
