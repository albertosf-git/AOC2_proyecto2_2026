...
-- Complete: activate Kill_IF where applicable
		Kill_IF <= salto_tomado and valid_I_ID;
-------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------
-- Data dependencies:
-- COMPLETE:
...
-- Data hazards:
	...
	JAL_uso_rs <= '1' when (rs_read = '1' and ((valid_I_EX = '1' and JAL_EX = '1' and Reg_Rs_ID = RW_EX) or (valid_I_MEM = '1' and JAL_MEM = '1' and Reg_Rs_ID = RW_MEM))) else '0';

	JAL_uso_rt <= '1' when (rt_read = '1' and ((valid_I_EX = '1' and JAL_EX = '1' and Reg_Rt_ID = RW_EX) or (valid_I_MEM = '1' and JAL_MEM = '1' and Reg_Rt_ID = RW_MEM))) else '0';
